...
- **2026-09-17 — v1.0.97** — Removed the carousel edge-fade feature entirely per feedback ("remove these white strips entirely to what we were before") — reverted the four commits that added/tuned it (v1.0.93–1.0.96: `.em-carousel-viewport`, the hero/brands/trust/category/rail wrapper classes, `.em-rail-viewport`). Home carousels are back to their pre-fade markup and CSS.
